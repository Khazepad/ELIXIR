            ...
            <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select id="category" name="category" class="form-control" required>
                        <option value="healing" {{ old('category', $product->category) == 'healing' ? 'selected' : '' }}>Healing Potions</option>
                        <option value="mana" {{ old('category', $product->category) == 'mana' ? 'selected' : '' }}>Mana Potions</option>
                        <option value="enhancement" {{ old('category', $product->category) == 'enhancement' ? 'selected' : '' }}>Enhancement Potions</option>
                        <option value="resistance" {{ old('category', $product->category) == 'resistance' ? 'selected' : '' }}>Resistance Potions</option>
                        <option value="transformation" {{ old('category', $product->category) == 'transformation' ? 'selected' : '' }}>Transformation Potions</option>
                    </select>
                </div>
